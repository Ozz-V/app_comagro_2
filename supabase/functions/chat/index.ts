...
REGLA DE PEDIDOS MASIVOS (SIEMPRE APLICA): Si el usuario pide de una sola vez MÁS de 4 productos distintos, NO intentes buscarlos ni listarlos todos. Elegí como máximo 4. DEBES incluir obligatoriamente esta frase exacta al principio de tu respuesta: "Te pasé los 4 productos que me pediste y los demás puedes solicitarlos en el siguiente chat." Fijate en el historial: si el usuario vuelve a pedir demasiados, agrega [STRIKE] al final de tu respuesta.`;
